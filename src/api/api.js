 ...
 * @returns
 */
export const watchParamSave = (data) => {
  return request({
    url: "/watchParamSave",
    method: "POST",
    data,
 ...
 * @returns
 */
export const webConfigList = (data) => {
  return request({
    url: "/webConfigList",
    method: "POST",
    data,
 ...
 * @returns
 */
export const webConfigSave = (data) => {
  return request({
    url: "/webConfigSave",
    method: "POST",
    data,
 ...
 * @returns
 */
export const webConfigSortSave = (data) => {
  return request({
    url: "/webConfigSortSave",
    method: "POST",
    data,
  });
};
 ...
 * 删除网页设置
 */
export const webConfigDel = (id) => {
  return request({
    url: "/webConfigDel?id=" + id,
    method: "GET",
  });
};
