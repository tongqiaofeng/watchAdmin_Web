  ...
  <div class="purchase-enter-container" id="purchaseEnter">
    <div v-if="pageSel == 0">
      ...
      <div style="margin-top: 30px">
        ...
        <el-tabs
          ref="dadTabs"
          v-model="activetopName"
          @tab-change="dadTabsChange"
        >
          <el-tab-pane label="采购信息" name="purchase">
            ...
            >
              <el-form-item label="采购日期：" prop="buyDate">
                <el-date-picker
                  v-model="watchStateMsgData.buyDate"
                  type="date"
                  placeholder="请选择"
                  format="YYYY-MM-DD"
              ...
              <el-form-item label="采购员：" prop="buyUserId">
                <el-select
                  style="width: 600px"
                  v-model="watchStateMsgData.buyUserId"
                  class="m-2"
                  placeholder="请选择"
                  size="large"
              ...
              <el-form-item label="采购单类型：" prop="buyType">
                <el-select
                  style="width: 600px"
                  v-model="watchStateMsgData.buyType"
                  class="m-2"
                  placeholder="请选择"
                  size="large"
                  @change="typeChange"
              ...
              <el-form-item
                label="采购店铺："
                prop="buySourceId"
                v-if="watchStateMsgData.buyType == 0"
              >
                <el-autocomplete
                  size="large"
                  style="width: 600px"
              ...
              <el-form-item
                label="贸易商："
                prop="buySourceId"
                v-if="watchStateMsgData.buyType == 1"
              >
                <el-select
                  style="width: 600px"
                  size="large"
              ...
              <el-tab-pane label="手表信息" name="first">
                ...
                >
                  <el-form-item label="采购价格:" prop="buyWatchPrice">
                    ...
                    <el-select
                      size="large"
                      v-model="watchStateMsgData.buyWatchCurrency"
                      @change="curChange"
                    >
                      <el-option
              ...
              <el-tab-pane label="付 款" name="second">
                ...
                >
                  ...
                  <el-form-item label="付款账单：">
                    ...
                    <el-table
                      :data="watchStateMsgData.buyCashFlowList"
                      style="width: 100%"
                    >
              ...
              <el-tab-pane label="退 税" name="third">
                ...
                >
                  ...
                  <el-form-item label="退税账单：">
                    ...
                    <el-table
                      :data="watchStateMsgData.taxCashFlowList"
                      style="width: 100%"
                    >
                      <el-table-column align="center" prop="time" label="日期">
                        <template #default="scope">
              ...
              <el-tab-pane label="佣 金" name="fourth">
                ...
                >
                  ...
                  <el-form-item label="佣金账单：">
                    ...
                    <el-table
                      :data="watchStateMsgData.commCashFlowList"
                      style="width: 100%"
                    >
                      <el-table-column align="center" prop="time" label="日期">
                        <template #default="scope">
              ...
              <el-tab-pane label="小 费" name="five">
                ...
                >
                  <el-form-item label="小费账单：">
                    ...
                    <el-table
                      :data="watchStateMsgData.feeCashFlowList"
                      style="width: 100%"
                    >
                      <el-table-column align="center" prop="time" label="日期">
                        <template #default="scope">
          ...
          <el-tab-pane label="运输信息" name="transport">
            ...
            >
              ...
              <el-form-item label="运费账单：">
                ...
                <el-table
                  :data="watchStateMsgData.logCashFlowList"
                  style="width: 100%"
                >
                  <el-table-column align="center" prop="time" label="日期">
                    <template #default="scope">
          ...
          >
            ...
            >
              ...
              <el-form-item
                ...
                v-if="watchStateMsgData.state == 5"
              >
                <el-select
                  style="width: 600px"
                  size="large"
              ...
              <el-form-item label="出售账单：">
                ...
                <el-table
                  :data="watchStateMsgData.sellCashFlowList"
                  style="width: 100%"
                >
                  <el-table-column align="center" prop="time" label="日期">
                    <template #default="scope">
          ...
          <el-tab-pane
            label="资金流"
            name="money"
            v-if="watchStateMsgData.allCashFlowList.length > 0"
          >
            <div
              style="
                width: 100%;
            ...
            <el-table
              :data="watchStateMsgData.allCashFlowList"
              style="width: 100%"
            >
              <el-table-column align="center" prop="time" label="日期">
                <template #default="scope">
