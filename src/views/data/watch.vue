            ...
            <el-tabs v-model="watchDeatilTabsActvie" class="watch-info-tabs">
              <el-tab-pane label="基本信息" name="first">
                ...
                <p v-if="watchDetail.isAuction">
                  <span class="label">是否为精品:</span>
                  <span class="value">{{ watchDetail.isAuction }}</span>
                </p>

                <p v-if="watchDetail.isNewStyle">
                  <span class="label">是否为新货:</span>
                  <span class="value">{{ watchDetail.isNewStyle }}</span>
                </p>
                <p v-if="watchDetail.isTop">
                  <span class="label">是否热卖:</span>
                ...
                <p v-if="watchDetail.isDisplay">
                  <span class="label">是否展示:</span>
                  <span class="value">{{ watchDetail.isDisplay }}</span>
                </p>
...
const showWatchDetail = async (id) => {
  ...
  if (res.code === 200) {
    ...
    watchDetail.isNewStyle = data.isNewStyle == 1 ? "是" : "否";
    watchDetail.isDisplay = data.isDisplay == 1 ? "是" : "否";
  }
};
...
const setDefaultWatchForm = () => {
  ...
  watchForm.isTop = 0;
  watchForm.isNewStyle = 0;
  watchForm.isDisplay = 0;
  watchForm.limited = "否";
  watchForm.pics = "";
  watchForm.special = "";
