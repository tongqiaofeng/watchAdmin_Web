                  ...
                  <div>
                    <el-form label-width="70px">
                      ...
                      <el-form-item label="出库图片" v-if="addDataConsign.state == 4">
                        <UploadImg :imgUrl="item.stockOutPic" :index="index" :imgType="2"
                          @imgChange="stockOutImgUrlChange"></UploadImg>
                      </el-form-item>
                    </el-form>
                  </div>
                </el-collapse-item>
              </el-collapse>
              <span v-show="addDataConsign.watchList.length == 0" style="font-size: 14px">右侧选择出售商品</span>
            </el-form-item>
          </el-form>
